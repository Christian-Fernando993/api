<?php 
    ...
    function api_photo_post(){
        ...
        $post_id = wp_insert_post($response);
         ...
         require_once ABSPATH . 'wp-admin/includes/img.php';
         require_once ABSPATH . 'wp-admin/includes/file.php';
         require_once ABSPATH . 'wp-admin/includes/media.php';

        $post_id = media_handle_upload('img', $post_id);
        update_post_meda($post_id, 'img', $post_id);
    ...
    function register_api_photo_post() {
        register_rest_route('api', '/photo', [
            'methods' => WP_REST_Server::CREATEBLE, 
